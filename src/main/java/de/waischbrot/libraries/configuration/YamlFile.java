...
public class YamlFile {
     ...
     * @since 2.1.0
     */
    public YamlFile(final Plugin plugin, final File configFile) {
        this.plugin = plugin;
     ...
     * @apiNote Config will be created in your plugin folder. If you want to set custom path use/instantiate {@link #YamlFile(Plugin, File)}.
     * @since 3.1.3
     */
    public YamlFile(final Plugin plugin, final String configName) {
